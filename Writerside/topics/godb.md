...
## preface
Godb, the fastest debugger written in Go, will revolutionize your brute-force analysis.
One day, when I was solving a reversing challenges with gdb-script, I thought it's convenient if there's any debugger which can be debugging in parallel.
Godb can brute-force 105 character flag in only 35 sec.
It was almost 37 times faster than gdb-script in same algorithm.

## install
```bash
git clone https://github.com/Yayoi-cs/godb.git
cd godb
rm -rf .git
go mod tidy
go run main.go
...
## how to use
All debugger function was written in the method of debugger structure.
